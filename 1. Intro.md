...
- This course is helpful for **GATE Preparation** in CSE & ECE.
...
![Electronics Milestones](./images/electronics_milestones.png)
...
* In Digital Signals, if we convert the signal into digital form, then send it, it still gets weaker and noise still creeps in but it can corrected easily.
  - **Exa:** Let's consider that 0 volts = 0 and 10 volts = 1.
  - At the source we send 10 volts and at the destination we received 7 volts.
  - We can still recover the value 1.
